...
func (c *Client) GenerateImage(ctx context.Context, prompt string, imageData []byte, mimeType string) ([]byte, error) {
	...
	resp, err := c.client.Models.GenerateContent(ctx, "gemini-3.1-flash-image", contents, nil)
	if err != nil {
